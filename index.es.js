...
var FontAwesomeIcon = defineComponent({
  ...
  setup: function setup(props) {
    ...
    var convertCurry = convert$1.bind(null, h);
    return function () {
...
var FontAwesomeLayers = defineComponent({
  ...
  setup: function setup(props, context) {
    ...
    var classes = [familyPrefix + '-layers'].concat(toConsumableArray(props.fixedWidth ? [familyPrefix + '-fw'] : []));

    return function () {
      return h('div', _extends({}, context.data, {
